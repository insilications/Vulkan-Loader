...
Version  : 1.1.129
Release  : 33
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.129/Vulkan-Loader-1.1.129.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.129/Vulkan-Loader-1.1.129.tar.gz
...
Patch1: 0001-build-Fix-Vulkan-registry-detection.patch
...
%prep
%setup -q -n Vulkan-Loader-1.1.129
cd %{_builddir}/Vulkan-Loader-1.1.129
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576006847
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Loader-1.1.129/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Loader/9bf8124f4495a48c4fd7104aebe2e957176b930b
pushd clr-build32
%make_install32
