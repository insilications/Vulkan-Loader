...
Version  : 1.1.100
Release  : 8
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.100.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.100.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.1.100
pushd ..
cp -a Vulkan-Loader-1.1.100 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1550243237
mkdir -p clr-build
pushd clr-build
