...
Version  : 1.1.125
Release  : 28
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.125/Vulkan-Loader-1.1.125.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.125/Vulkan-Loader-1.1.125.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.1.125
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571285040
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Loader-1.1.125/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Loader/9bf8124f4495a48c4fd7104aebe2e957176b930b
pushd clr-build32
%make_install32
...
/usr/lib64/libvulkan.so.1.1.125

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.1.125
