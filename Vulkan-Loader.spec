...
Version  : 1.1.123
Release  : 25
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.123/Vulkan-Loader-1.1.123.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.123/Vulkan-Loader-1.1.123.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.1.123
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568914738
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libvulkan.so.1.1.122

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.1.122
