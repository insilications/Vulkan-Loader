...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.102.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.1.102
pushd ..
cp -a Vulkan-Loader-1.1.102 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1551851501
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libvulkan.so.1.1.102

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.1.102
