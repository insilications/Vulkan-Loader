...
Version  : 1.1.108
Release  : 14
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.108/Vulkan-Loader-1.1.108.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.108/Vulkan-Loader-1.1.108.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.1.108
...
export LANG=C
export SOURCE_DATE_EPOCH=1559241915
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libvulkan.so.1.1.108

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.1.108
