...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.2.137/Vulkan-Loader-1.2.137.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.2.137
cd %{_builddir}/Vulkan-Loader-1.2.137
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586875840
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/Vulkan-Loader-1.2.137/LICENSE.txt %{buildroot}/usr/share/package-licenses/Vulkan-Loader/9bf8124f4495a48c4fd7104aebe2e957176b930b
pushd clr-build32
%make_install32
