...
Version  : 1.1.97
Release  : 4
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.97.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.97.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.1.97
pushd ..
cp -a Vulkan-Loader-1.1.97 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1547672792
mkdir -p clr-build
pushd clr-build
