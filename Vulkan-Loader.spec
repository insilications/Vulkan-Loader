...
Version  : 1.1.82.0
Release  : 1
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/sdk-1.1.82.0.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/sdk-1.1.82.0.tar.gz
Summary  : Vulkan Loader
Group    : Development/Tools
License  : Apache-2.0 BSD-3-Clause MIT
Requires: Vulkan-Loader-lib
Requires: Vulkan-Loader-license
...
%prep
%setup -q -n Vulkan-Loader-sdk-1.1.82.0
pushd ..
cp -a Vulkan-Loader-sdk-1.1.82.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1537899027
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libvulkan.so.1.1.82

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.1.82
