...
Version  : 1.1.120
Release  : 21
URL      : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.120/Vulkan-Loader-1.1.120.tar.gz
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.120/Vulkan-Loader-1.1.120.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.1.120
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1566503430
mkdir -p clr-build
pushd clr-build
