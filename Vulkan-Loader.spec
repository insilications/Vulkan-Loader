...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.101.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.1.101
pushd ..
cp -a Vulkan-Loader-1.1.101 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1550722433
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libvulkan.so.1.1.100

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libvulkan.so.1
/usr/lib32/libvulkan.so.1.1.100
