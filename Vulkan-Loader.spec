...
Source0  : https://github.com/KhronosGroup/Vulkan-Loader/archive/v1.1.113/Vulkan-Loader-1.1.113.tar.gz
...
%prep
%setup -q -n Vulkan-Loader-1.1.113
...
export LANG=C
export SOURCE_DATE_EPOCH=1562036463
mkdir -p clr-build
pushd clr-build
